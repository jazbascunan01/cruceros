    ...
    {foreach from=$cruceros item=$crucero}
        <section class="recuadroadmin">
            ...
            <section class="buttons_admin">
                <button class="buttonadmin" type="submit"><a href="eliminar/{$crucero->ID}"><img class="logo_nav" id="btnadmin"
                            src="images/logo_borrar.png" alt="logo borrar"></a></button>
                <button class="buttonadmin" type="submit"><a href="editar/{$crucero->ID}"><img class="logo_nav" id="btnadmin"
